...
(function (domGlobals) {
    ...
    var getDefaultSize = function (editor) {
      return editor.getParam('image_default_size', {}, 'object');
    };
    ...
    var changeSrc = function (helpers, info, state, api) {
      ...
      if (typeof info.defaultSize == 'object' && Object.keys(info.defaultSize).length > 0) {
        api.setData({ dimensions: info.defaultSize });
      } else {
