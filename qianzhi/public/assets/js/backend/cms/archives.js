    ...
    var Controller = {
        index: function () {
                            ...
                            buttons:[
                                {
                                    ...
                                    text:"参数",
                                    icon:"fa fa-pencil",
                                    url:"/cms.php/cms/parame",
                                    classname:"btn btn-xs btn-warning btn-click",
                                    click:function(value, row){
                                        //点击事件
                                        var urls = "/cms.php/cms/parame";
                                        //var title = server.urlencode("%20"," ",row.title);;
                                        urls = (urls + '?name=' + row.id)
                                        Fast.api.addtabs(urls, __('Add'), $(this).data() || {});
                                    }
                                }
                            ]
                        },
			...
			$(document).on('click', '.btn-copy', function () {
                ...
                Layer.open({
                    title: __('Copy'),
                    content: '<i class="layui-layer-ico layui-layer-ico3"></i><p style="margin:0 0 0 35px">'+ __('Confirm Copy') +' ？</p>',
                    btn: [__('Copy'), __('Cancel')],
                    yes: function (index, layero) {
                        Fast.api.ajax({
                            url: "cms/archives/copyArchives/ids/" + ids.join(","),
                            type: "post",
                            data: {},
                        }, function () {
                            table.bootstrapTable('refresh', {});
